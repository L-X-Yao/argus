...
KNOWN_ORPHAN_LOCALE_KEYS: set[str] = {
    ...
    'fft.amplitude', 'fft.frequency', 'fft.harmonics', 'fft.notchFreq',
    'fft.notchHint', 'fft.peak', 'fltdb.count', 'fltdb.delete',
    'fltdb.noData', 'fltdb.replay', 'fltdb.title', 'frame.boat',
    'frame.quadplane', 'frame.rover', 'frame.sub', 'inspector.expanded',
    'kml.overlay', 'logview.timeline', 'multi.observer', 'pid.reset',
    'plugin.load', 'plugin.noPlugins', 'plugin.title', 'posSource.bad',
    'posSource.good', 'posSource.optFlow.bad', 'posSource.optFlow.good',
    'posSource.optFlow.warn', 'posSource.warn', 'prearm.fail',
    'prearm.pass', 'prearm.unknown', 'preflight.save', 'rally.add',
    'rally.clear', 'rally.hint', 'rally.title', 'rally.upload',
    'rally.uploaded', 'rccal.mapping', 'rccal.step1', 'rccal.step2',
    'rccal.step3', 'safety.parachute', 'safety.parachuteConfirm',
    'safety.terminate', 'safety.terminateConfirm', 'sched.status.active',
    'sched.status.completed', 'sched.status.pending', 'settings.flightParams',
    'settings.mapRegion', 'settings.safety', 'settings.ui',
    'settings.zhLabel', 'toast.armFail', 'toast.arming',
    'toast.invalidValue', 'toast.missionStart', 'toast.outOfRange',
    'toast.takeoffFail', 'units.fpm', 'units.ft', 'units.imperial',
    'units.kts', 'units.metric', 'units.mi', 'units.mph',
    'video.screenshot',
}
