...
- **Tests**: pytest (backend + contract, 1156 tests), vitest 4 (frontend, 487 tests), Playwright (E2E, 19 specs), SITL verification (126/134 items). Current verification status per feature: `docs/FEATURE_CHECKLIST.md`. Don't-refactor decisions: `docs/protocol_design.md`.
