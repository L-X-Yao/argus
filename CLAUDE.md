...
- **Tests**: pytest (backend + contract, 1037 tests), vitest 4 (frontend, 462 tests), Playwright (E2E, 19 specs). Current verification status per feature: `docs/FEATURE_CHECKLIST.md`. Don't-refactor decisions: `docs/protocol_design.md`.
...
npx vitest run                 # Frontend tests (462)
