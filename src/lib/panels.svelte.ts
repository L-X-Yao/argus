...
export const PANEL_LOADERS: Record<PanelId, () => Promise<{ default: any }>> = {
  ...
  flightReport:  () => import('../components/shared/FlightReportPanel.svelte'),
  ...
  advCmd:        () => import('../components/shared/AdvancedCmdPanel.svelte'),
  ...
  remote:        () => import('../components/shared/RemotePanel.svelte'),
  ...
  posSource:     () => import('../components/shared/PositionSourcePanel.svelte'),
  ntrip:         () => import('../components/shared/NtripPanel.svelte'),
