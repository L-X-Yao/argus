...
| 143 | 加速度计6方向校准向导 | ✅ᵗ | 6姿态图示(水平/仰头/低头/左/右/后), FC statustext自动推进, X/6进度 |
| 144 | 罗盘校准SVG进度 | ✅ᵗ | 动画SVG圆环进度(0-100%), 旋转箭头动画, ~3%/FC消息估算 |
| 145 | 校准事件关键词过滤 | ✅ᵗ | 20+中英文关键词过滤事件到校准日志区, 最近20条滚动显示 |
