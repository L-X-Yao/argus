...
- `/home/plkj/samba/filght/argus/backend/commands/_setup.py` (lines 106-132)
- `/home/plkj/samba/filght/argus/backend/mavlink_handlers.py` (lines 450-458, 506-545)
- `/home/plkj/samba/filght/argus/backend/state.py` (LogState, lines 106-113)
- `/home/plkj/samba/filght/argus/backend/ws_manager.py` (log_messages push, lines 147, 166, 185-190)
- `/home/plkj/samba/filght/argus/scripts/sim_pllink.py` (lines 467-493 — sim bug P5)
- `/home/plkj/samba/filght/argus/src/components/tools/LogPanel.svelte` (no armed-check UI)
